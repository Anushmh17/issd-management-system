<?php
// =====================================================
// LEARN Management - Student: Notices
// =====================================================
...
<div id="page-content">
  <div class="page-header">
    <div class="page-header-left">
      ...
      <div class="breadcrumb-custom"><i class="fas fa-home"></i> Student &rsaquo; <span>Notices</span></div>
    </div>
  </div>

  <div class="card-lms">
    <div class="card-lms-header">
        <div class="card-lms-title"><i class="fas fa-bell"></i> Official Notices</div>
    ...
    <div class="card-lms-body">
        <?php if(empty($notices)): ?>
            <div class="empty-state"><i class="fas fa-bell-slash"></i><p>No notices available for you.</p></div>
        <?php else: ?>
            <div style="display:grid;gap:16px;">
                ...
                <div class="notice-card-clickable" 
                     ...
                     style="background:var(--bg-page);border-radius:12px;border:1px solid var(--border-color);padding:20px;border-left:4px solid var(--accent);">
